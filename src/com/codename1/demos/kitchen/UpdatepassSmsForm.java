 ...
 * @author Shai Almog
 */
public class UpdatepassSmsForm extends Demo {
    ...
    public Container createDemo(Form parent) {
        ...
        addComps(parent, comps,
                new Label("Enter the sended Key", "InputContainerLabel"),
                nameup,
                new Label("The new Password !", "InputContainerLabel"),
                lastnameup,
