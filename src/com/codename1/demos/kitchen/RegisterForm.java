...
public class RegisterForm extends Demo {
    ...
    static TextField name, lastname, email, password, passwordconfirm, phonenumber, username;
    ...
    public Container createDemo(Form parent) {
        ...
        FontImage.setMaterialIcon(username.getHintLabel(), FontImage.MATERIAL_PEOPLE);
        ...
        addComps(parent, comps,
                new Label("UserName", "InputContainerLabel"),
                username,
